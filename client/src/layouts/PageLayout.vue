...
<template>
    ...
    <Drawer v-model:visible="drawerVisible" header="LIMS | Navigation" class="font-poppins">
        <div class="w-full h-full flex flex-col jutify-start items-start">
            ...
            <div class="w-full flex flex-col justify-start items-start gap-2 p-2">
              <span class="uppercase font-medium text-lg">Stock Cards Directory</span>
              <span v-if="auth.isAdmin" @click="navigateTo('/admin/stock_cards')" class="w-full py-2 pl-2 cursor-pointer hover:bg-emerald-700 hover:text-white" :class="route.name === 'Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Stock Cards Masterlist</span>
              <div v-if="auth.isAdmin" class="w-full flex flex-col justify-start items-start gap-2 ml-6 text-sm">
                  <span @click="navigateTo('/admin/stock_cards/drugs_and_medicines')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'Drugs and Medicines Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Drugs and Medicines</span>
                  <span @click="navigateTo('/admin/stock_cards/medical_equipments')"class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'Medical Equipments Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Medical Equipments</span>
                  <span @click="navigateTo('/admin/stock_cards/ict_equipments')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'ICT Equipments Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">ICT Equipments</span>
                  <span @click="navigateTo('/admin/stock_cards/tokens')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'Tokens Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Tokens</span>
                  <span @click="navigateTo('/admin/stock_cards/iec')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'IEC Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">IEC</span>
                  <span @click="navigateTo('/admin/stock_cards/medical_and_dental_laboratory_supplies')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'Medical Dental Laboratory Supplies Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Medical and Dental Laboratory Supply</span>
                  <span @click="navigateTo('/admin/stock_cards/ict_supplies')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'ICT Supplies Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">ICT Supplies</span>
                  <span @click="navigateTo('/admin/stock_cards/office_supplies')" class="w-full p-2 hover:bg-emerald-700 hover:text-white cursor-pointer" :class="route.name === 'Office Supplies Stock Cards' ? 'bg-emerald-700 text-white shadow-md shadow-slate-600' : '' ">Office Supplies</span>
              </div>
